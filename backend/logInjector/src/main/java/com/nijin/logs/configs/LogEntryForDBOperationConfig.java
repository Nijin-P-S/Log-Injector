package com.nijin.logs.configs;
...
/**
 * Configuration class for RabbitMQ operations related to logEntry to Queue operations.
...
@Configuration
@Getter
public class LogEntryForDBOperationConfig {
